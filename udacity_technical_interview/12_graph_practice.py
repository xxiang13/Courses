...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        return [(edges.value, edges.node_from.value, edges.node_to.value) for edges in self.edges]
    ...
    def get_adjacency_list(self):
        ...
        adjacency_list = [None]*(max(node.value for node in self.nodes)+1)
        node_check = []
        for edge in self.edges:
            if edge.node_from.value in node_check:
                ...
                node_check.append(edge.node_from.value)
